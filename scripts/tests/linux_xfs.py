#!/usr/bin/env python3
"""Native Linux lifecycle regression; run on a reflink-enabled XFS filesystem.
    ...
    for parent, dirs, _ in os.walk(root):
        for name in dirs:
            ...
            if not path.is_symlink():
                path.chmod(0o700)
    print('linux_xfs: reflink, isolation, metadata, hardlinks, sparse copy, lifecycle, pool: PASS')
